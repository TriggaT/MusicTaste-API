...
Song.create(title: "Title 5", artist: "Artist 1", playlist_id: 3)
Song.create(title: "Title 6", artist: "Artist 2", playlist_id: 3)
Song.create(title: "Title 7", artist: "Artist 3", playlist_id: 4)
Song.create(title: "Title 8", artist: "Artist 4", playlist_id: 4)
